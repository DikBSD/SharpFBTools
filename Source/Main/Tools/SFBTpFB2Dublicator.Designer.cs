...
namespace SharpFBTools.Tools
{
	partial class SFBTpFB2Dublicator
	{
		...
		private void InitializeComponent()
		{
			...
			this.tsbtnDupCopy = new System.Windows.Forms.ToolStripButton();
			...
			// pProgress
			// 
			this.pProgress.Controls.Add(this.tcViewFB2Desc);
			this.pProgress.Controls.Add(this.lvFilesCount);
			this.pProgress.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.pProgress.Location = new System.Drawing.Point(0, 325);
			this.pProgress.Name = "pProgress";
			this.pProgress.Size = new System.Drawing.Size(828, 213);
			...
			this.pSearchFBDup2Dirs.Size = new System.Drawing.Size(828, 55);
			...
			this.lblDupToDir.Location = new System.Drawing.Point(3, 33);
			...
			this.tboxDupToDir.Location = new System.Drawing.Point(166, 31);
			this.tboxDupToDir.Name = "tboxDupToDir";
			this.tboxDupToDir.Size = new System.Drawing.Size(484, 20);
			...
			// tsbtnToDir
			// 
			this.tsbtnToDir.Image = ((System.Drawing.Image)(resources.GetObject("tsbtnToDir.Image")));
			this.tsbtnToDir.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.tsbtnToDir.Name = "tsbtnToDir";
			this.tsbtnToDir.Size = new System.Drawing.Size(124, 28);
			this.tsbtnToDir.Text = "Папка - приемник";
			this.tsbtnToDir.Click += new System.EventHandler(this.TsbtnToDirClick);
			// 
			// tsSep1
			// 
			...
			// tsbtnDupCopy
			// 
			this.tsbtnDupCopy.Enabled = false;
			this.tsbtnDupCopy.Image = ((System.Drawing.Image)(resources.GetObject("tsbtnDupCopy.Image")));
			this.tsbtnDupCopy.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.tsbtnDupCopy.Name = "tsbtnDupCopy";
			this.tsbtnDupCopy.Size = new System.Drawing.Size(96, 28);
			this.tsbtnDupCopy.Text = "Копировать";
			this.tsbtnDupCopy.Click += new System.EventHandler(this.TsbtnDupCopyClick);
			// 
			// tsbtnDupMove
			// 
			this.tsbtnDupMove.Enabled = false;
			this.tsbtnDupMove.Image = ((System.Drawing.Image)(resources.GetObject("tsbtnDupMove.Image")));
			this.tsbtnDupMove.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.tsbtnDupMove.Name = "tsbtnDupMove";
			this.tsbtnDupMove.Size = new System.Drawing.Size(101, 28);
			this.tsbtnDupMove.Text = "Переместить";
			this.tsbtnDupMove.Click += new System.EventHandler(this.TsbtnDupMoveClick);
			// 
			// tsbtnDupDelete
			// 
			this.tsbtnDupDelete.Enabled = false;
			this.tsbtnDupDelete.Image = ((System.Drawing.Image)(resources.GetObject("tsbtnDupDelete.Image")));
			this.tsbtnDupDelete.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.tsbtnDupDelete.Name = "tsbtnDupDelete";
			this.tsbtnDupDelete.Size = new System.Drawing.Size(79, 28);
			this.tsbtnDupDelete.Text = "Удалить";
			this.tsbtnDupDelete.Click += new System.EventHandler(this.TsbtnDupDeleteClick);
			// 
			// tsbtnDupWorkStop
			// 
			this.tsbtnDupWorkStop.Enabled = false;
			this.tsbtnDupWorkStop.Image = ((System.Drawing.Image)(resources.GetObject("tsbtnDupWorkStop.Image")));
			this.tsbtnDupWorkStop.ImageTransparentColor = System.Drawing.Color.Magenta;
			...
			this.pMode.Location = new System.Drawing.Point(0, 86);
			...
			this.cboxMode.Items.AddRange(new object[] {
									"Id Книги (копии и (или) разные версии правки одной и той же книги - одинаковый Id" +
												")",
									"Название Книги (могут быть найдены и разные книги разных Авторов, но с одинаковым" +
												" Названием)",
									"Автор(ы) и Название Книги (одна и та же книга, сделанная разными людьми - разные " +
			...
			// pExistFile
			// 
			this.pExistFile.Controls.Add(this.chBoxAddFileNameBookID);
			...
			this.pExistFile.Location = new System.Drawing.Point(0, 112);
			this.pExistFile.Name = "pExistFile";
			this.pExistFile.Size = new System.Drawing.Size(828, 28);
			this.pExistFile.TabIndex = 39;
			// 
			// chBoxAddFileNameBookID
			// 
			this.chBoxAddFileNameBookID.Enabled = false;
			this.chBoxAddFileNameBookID.Font = new System.Drawing.Font("Tahoma", 8F, System.Drawing.FontStyle.Bold);
			this.chBoxAddFileNameBookID.ForeColor = System.Drawing.Color.Navy;
			this.chBoxAddFileNameBookID.Location = new System.Drawing.Point(541, 5);
			this.chBoxAddFileNameBookID.Name = "chBoxAddFileNameBookID";
			this.chBoxAddFileNameBookID.Size = new System.Drawing.Size(232, 18);
			...
			this.cboxDupExistFile.Location = new System.Drawing.Point(166, 3);
			this.cboxDupExistFile.Name = "cboxDupExistFile";
			this.cboxDupExistFile.Size = new System.Drawing.Size(369, 21);
		...
		private System.Windows.Forms.ToolStripButton tsbtnDupWorkStop;
		private System.Windows.Forms.ToolStripButton tsbtnDupDelete;
		private System.Windows.Forms.ToolStripButton tsbtnDupMove;
		private System.Windows.Forms.ToolStripButton tsbtnDupCopy;
		private System.Windows.Forms.ToolStripSeparator toolStripSeparator3;
		private System.Windows.Forms.ToolStripSeparator toolStripSeparator2;
		private System.Windows.Forms.ToolStripButton tsbtnToDir;
