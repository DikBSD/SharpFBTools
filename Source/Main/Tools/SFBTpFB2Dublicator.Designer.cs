...
namespace SharpFBTools.Tools
{
	partial class SFBTpFB2Dublicator
	{
		...
		private void InitializeComponent()
		{
			...
			// tpMode
			// 
			this.tpMode.Controls.Add(this.pOptions);
			this.tpMode.Controls.Add(this.pMode);
			...
			// pMode
			// 
			this.pMode.Controls.Add(this.cboxExistArchive);
			...
			this.pMode.Size = new System.Drawing.Size(814, 26);
			...
			this.lblMode.Size = new System.Drawing.Size(76, 18);
			this.lblMode.TabIndex = 0;
			this.lblMode.Text = "Сравнение:";
			// 
			// cboxExistArchive
			// 
			this.cboxExistArchive.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
									| System.Windows.Forms.AnchorStyles.Right)));
			...
			this.cboxExistArchive.Items.AddRange(new object[] {
									"По Id Книги",
									"По Id Книги, версии fb2-файла",
									"По Id Книги, версии fb2-файла, Названию Книги",
									"По Id Книги, версии fb2-файла, Названию Книги, Автору(ам)",
									"По Id Книги, версии fb2-файла, Названию Книги, Автору(ам), Жанру(ам)",
									"Настраиваемое"});
			this.cboxExistArchive.Location = new System.Drawing.Point(81, 0);
			this.cboxExistArchive.Name = "cboxExistArchive";
			this.cboxExistArchive.Size = new System.Drawing.Size(730, 21);
			this.cboxExistArchive.TabIndex = 17;
			// 
			// pOptions
			// 
			this.pOptions.Dock = System.Windows.Forms.DockStyle.Fill;
			this.pOptions.Location = new System.Drawing.Point(3, 29);
			this.pOptions.Name = "pOptions";
			this.pOptions.Size = new System.Drawing.Size(814, 166);
