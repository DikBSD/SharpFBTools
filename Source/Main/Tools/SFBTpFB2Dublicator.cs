...
namespace SharpFBTools.Tools
{
	...
	public partial class SFBTpFB2Dublicator : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.tsmiAnalyzeInGroup.Text = "Все \"старые\" fb2 (только по версии книги)";
			...
			this.tsmiAllOldBooksForAllGroups.Text = "Все \"старые\" fb2 (только по версии книги)";
...
//				MiscListView.AutoResizeColumns( listViewFB2Files );
		...
		{
			checkOldBook( GroupAnalyzeMode.AllGroup, CompareMode.VersionValidate );
		}
		...
		{
			checkOldBook( GroupAnalyzeMode.Group, CompareMode.VersionValidate );
		}
