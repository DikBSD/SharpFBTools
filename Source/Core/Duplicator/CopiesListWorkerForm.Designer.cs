...
{
	partial class CopiesListWorkerForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CopiesListWorkerForm));
			...
			// ProgressBar
			// 
			this.ProgressBar.Location = new System.Drawing.Point(8, 17);
			this.ProgressBar.Margin = new System.Windows.Forms.Padding(4);
			this.ProgressBar.Name = "ProgressBar";
			this.ProgressBar.Size = new System.Drawing.Size(653, 41);
			this.ProgressBar.TabIndex = 2;
			// 
			// CopiesListWorkerForm
			// 
			...
			this.Name = "CopiesListWorkerForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Обработка fb2 файлов";
