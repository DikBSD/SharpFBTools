...
{
	partial class CopiesAnalyzeForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CopiesAnalyzeForm));
			...
			// ProgressBar
			// 
			this.ProgressBar.Location = new System.Drawing.Point(9, 17);
			...
			this.Name = "CopiesAnalyzeForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Анализ копий книг";
