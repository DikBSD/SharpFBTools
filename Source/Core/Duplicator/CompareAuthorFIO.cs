...
namespace Core.Duplicator
{
    ...
    class CompareAuthorFIO
    {
        ...
        public bool FilesHashForAuthorFIOParser(BackgroundWorker bw, DoWorkEventArgs e,
                                                Label StatusLabel, ProgressBar ProgressBar, string TempDir,
                                                List<string> FilesList, HashtableClass htFB2ForAuthorFIO, bool WithMiddleName)
        {
            StatusLabel.Text += "Хэширование в контексте Авторов с одинаковой Фамилией и инициалами...\r";
