...
namespace Core.Common
{
	...
	public class Enums
	{
		...
		public enum SearchCompareModeEnum : byte {
			...
			BookID				    = 1, // Одинаковый Id Книги (копии и/или разные версии правки одной и той же книги)
			BookTitle			    = 2, // Название Книги (могут быть найдены и разные книги разных Авторов,
									     //    но с одинаковым Названием)
			AuthorBookTitle		    = 3, // Автор(ы) и Название Книги (одна и та же книга, сделанная разными людьми - 
									     //    разные Id, но Автор и Название - одинаковые)
			AuthorFIO			    = 4, // Авторы с одинаковой Фамилией и инициалами
            AuthorBookTitleBookID   = 5, // Автор(ы), Название Книги и Одинаковый Id Книги
                                         //    (разделять по разным группам разные издания книг)
            BookTitleBookID         = 6, // Название Книги и Id Книги (Авторы книги могут быть разными)
            AuthorBookTitleFB2Author = 7, // Автор(ы), Название Книги и Автор fb2 файла (одна и та же книга, сделанная разными людьми)
            AuthorBookTitleBookIDFB2Author = 8, // Автор(ы), Название Книги, Id Книги и Автор fb2 файла
            BookTitleBookIDFB2Author = 9,   // Название Книги, Id Книги и Автор fb2 файла
            AuthorBookIDFB2Author = 10,     // Автор(ы), Id Книги и Автор fb2 файла
        }
