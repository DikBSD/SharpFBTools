...
namespace Core.Common
{
	...
	public class Enums
	{
		...
		public enum SearchCompareModeEnum : byte {
			...
			BookTitle			    = 2, // 2. Название Книги (могут быть найдены и разные книги разных Авторов,
									     //    но с одинаковым Названием)
			AuthorBookTitle		    = 3, // 3. Автор(ы) и Название Книги (одна и та же книга, сделанная разными людьми - 
									     //    разные Id, но Автор и Название - одинаковые)
			AuthorFIO			    = 4, // 4. Авторы с одинаковой Фамилией и инициалами
            AuthorBookTitleBookID   = 5, // 5. Автор(ы), Название Книги и Одинаковый Id Книги
            ...
            AuthorBookTitleBookIDFB2Author = 8, // 8. Автор(ы), Название Книги, Id Книги и Автор fb2 файла
            BookTitleBookIDFB2Author = 9,   // 9. Название Книги, Id Книги и Автор fb2 файла
            AuthorBookIDFB2Author = 10,     // 10. Автор(ы), Id Книги и Автор fb2 файла
        }
