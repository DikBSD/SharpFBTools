...
namespace Core.Common
{
	...
	public class Enums
	{
		...
		public enum SearchCompareModeEnum : byte {
			...
			AuthorAndTitle		= 3, // 3. Автор(ы) и Название Книги (одна и та же книга, сделанная разными людьми - 
									 //    разные Id, но Автор и Название - одинаковые)
			AuthorFIO			= 4, // 4. Авторы с одинаковой Фамилией и инициалами
            AuthorAndTitleAndId = 5, // 5. Автор(ы), Название и Одинаковый Id Книги
                                     //    (разделять по разным группам разные издания книг)
            BookTitleAndBookID = 6,  // 6. Название Книги и Id Книги (Авторы книги могут быть разными)
        }
