...
namespace Core.Common
{
	...
	public class Enums
	{
		...
		public enum SearchCompareModeEnum : byte {
			Md5								= 0,	// Абсолютно одинаковые книги (md5)
            AuthorBookTitleBookIDFB2Author	= 1,	// Название Книги, Автор(ы), Id Книги и Автор fb2 файла
			AuthorBookIDFB2Author			= 2,	// Автор(ы), Id Книги и Автор fb2 файла
			BookTitleBookIDFB2Author		= 3,	// Название Книги, Id Книги и Автор fb2 файла
			AuthorBookTitleFB2Author		= 4,	// Название Книги, Автор(ы) и Автор fb2 файла (одна и та же книга, сделанная разными людьми)
			AuthorBookTitleBookID			= 5,	// Автор(ы), Название Книги и Одинаковый Id Книги
													//		(разделять по разным группам разные издания книг)
			AuthorBookTitle					= 6,    // Название Книги и Автор(ы) (одна и та же книга, сделанная разными людьми - 
													//		разные Id, но Автор и Название - одинаковые)
			BookTitleBookID					= 7,	// Название Книги и Id Книги (Авторы книги могут быть разными)
			BookTitle						= 8,	// Название Книги (могут быть найдены и разные книги разных Авторов,
													//		но с одинаковым Названием)
			BookID							= 9,	// Одинаковый Id Книги (копии и/или разные версии правки одной и той же книги)
			AuthorFIO						= 10,   // Авторы с одинаковой Фамилией и инициалами
			AuthorFB2Author					= 11,	// Автор(ы) и Автор fb2 файла
		}
		...
		/// <summary>
		/// Режимы автокорректировки книг (единичный или пакетный режим)
		/// </summary>
		public enum BooksAutoCorrectProcessingModeEnum : byte {
			OneBookProcessing,	// режим правки одной книги
			BatchProcessing,	// пакетный режим
		}
